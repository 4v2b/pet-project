...
const DOT_NET_API_URL = 'https://dotnet-v4pet-project-prod.azurewebsites.net/api';
const PYTHON_API_URL = 'https://python-v4-pet-project-prod.azurewebsites.net/api/';
